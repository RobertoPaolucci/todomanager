...
export default function BookingForm({
  ...
  const isDirectChannel = useMemo(() => {
    const type = String(selectedChannel?.type ?? "").trim().toLowerCase();
    const name = String(selectedChannel?.name ?? "").trim().toLowerCase();
  ...
  useEffect(() => {
    ...
    async function loadNextReference() {
      try {
        ...
        const res = await fetch("/api/bookings/next-direct-ref", {
          cache: "no-store",
        });
  ...
  }, [isDirectChannel, bookingReference, viewOnly]);
  ...
  }, [isDirectChannel, bookingReference, autoGeneratedReference, viewOnly]);
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="min-w-0">
            ...
            <input
              ...
              placeholder={
                isDirectChannel ? "Generato automaticamente" : "Es. VIATOR-847392"
              }
              className={inputBaseStyle}
            />
            {!viewOnly && isDirectChannel && loadingAutoReference ? (
